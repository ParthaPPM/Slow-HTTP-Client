package com.ppm.slowclient.https;
...
public class HttpsClient
{
	...
	public HttpsClient(String host, boolean followRedirects)
	{
	...
	public HttpsClient(String host, int port, boolean followRedirects)
	{
		this(host, port, false, followRedirects);
	}

	public HttpsClient(String host, boolean keepConnectionOpen, boolean followRedirects)
	{
		this(host, 443, keepConnectionOpen, followRedirects);
	}

	public HttpsClient(String host, int port, boolean keepConnectionOpen, boolean followRedirects)
	{
		this.host = host;
		this.HTTP_PORT = port;
		this.socket = null;
	...
	public void makeRequest()
	{
		...
		try
		{
			...
			if(socket == null)
			{
				socket = SSLSocketFactory.getDefault().createSocket(host, HTTP_PORT);
			}
